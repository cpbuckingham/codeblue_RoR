...
class CodersControllerTest < ActionController::TestCase
  ...
  test "should create coder" do
    assert_difference('Coder.count') do
      post :create, coder: { email: @coder.email, github_username: @coder.github_username, name: @coder.name }
    end
  ...
  test "should update coder" do
    patch :update, id: @coder, coder: { email: @coder.email, github_username: @coder.github_username, name: @coder.name }
    assert_redirected_to coder_path(assigns(:coder))
  end
